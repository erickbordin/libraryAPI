...
public class AutorService {
    ...
    public void atualizar(Autor autor) {
        if (autor.getId() == null) {
            throw new IllegalArgumentException("para atualizar eh necessario ter o id salvo");
        }
        validator.validar(autor);
    ...
    public void deletar(Autor autor) {
        if (possuiLivro(autor)) {
            throw new OperacaoNaoPermitidaException("Nao eh permitido um autor que possui livros cadastrados");
        }
